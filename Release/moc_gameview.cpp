...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_GameView_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_GameView_t qt_meta_stringdata_GameView = {
    {
        QT_MOC_LITERAL(0, 8),  // "GameView"
        QT_MOC_LITERAL(9, 14),  // "tellClickedPos"
        QT_MOC_LITERAL(24, 0),  // ""
...
Q_CONSTINIT static const uint qt_meta_data_GameView[] = {
...
Q_CONSTINIT const QMetaObject GameView::staticMetaObject = { {
    ...
    qt_meta_stringdata_GameView.offsetsAndSizes,
    qt_meta_data_GameView,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_GameView_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<GameView, std::true_type>,
        // method 'tellClickedPos'
...
void GameView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->tellClickedPos((*reinterpret_cast< std::add_pointer_t<QPointF>>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (GameView::*)(QPointF );
            if (_t _q_method = &GameView::tellClickedPos; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void GameView::tellClickedPos(QPointF _t1)
{
